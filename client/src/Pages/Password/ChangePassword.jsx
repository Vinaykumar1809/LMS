...
const ChangePassword = () => {
  ...
  const handleFormSubmit = async (event) => {
    ...
    if (
      !userPassword.newPassword.match(/^(?=.*[a-zA-Z0-9])(?=.*[^a-zA-Z0-9]).{6,20}$/)
    ) {
      toast.error(
        "Password must be 6-20 characters long, contain letters or numbers, and at least one special character"
      );
      return;
    }
